...
//        return "redirect:/employee/all";
    ...
    public ModelAndView deleteCar(@PathVariable("id") @NotNull @Min(1) @Max(100) long id, ModelAndView modelAndView) {
/*        if (id < 1){
            throw new IllegalArgumentException ("exc: id must not be less than 1"); // Исключение выбрасывается, если id не валиден
        }*/
